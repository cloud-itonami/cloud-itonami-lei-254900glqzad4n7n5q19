(ns tosmonitor.store
  ...
  This repo archives exactly ONE company (Public Storage, LEI
  254900GLQZAD4N7N5Q19) -- unlike `commitledger.store`'s multi-application
...
(def ^:private demo-full-text
  "Terms and Conditions\nThese Terms and Conditions govern your use of the Public Storage website and any online reservation or rental services offered through it. By using this site you agree to be bound by these Terms. This agreement is governed by the laws of the State of Maryland.")

(defn demo-baseline []
  {:full-text    demo-full-text
   :source-url   "https://www.publicstorage.com/terms-and-conditions/terms-and-conditions.html"

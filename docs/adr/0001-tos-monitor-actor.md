...
Public Storage, per ADR-2607110300 -- a read-only reference archive. As
...
- **Company**: Public Storage, LEI 254900GLQZAD4N7N5Q19, website
  `https://www.publicstorage.com`.
- **Baseline provenance** (real, from this repo's own `80-data/public/
  tos.journal.edn`): source-url
  `https://www.publicstorage.com/terms-and-conditions/terms-and-conditions.html`,
